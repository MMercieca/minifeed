...
ActiveRecord::Schema[7.0].define(version: 2022_03_26_172615) do
  ...
  create_table "known_feeds", force: :cascade do |t|
    t.string "name"
    t.string "identifier"
    t.time "poll_at"
    t.datetime "created_at", null: false
  ...
  add_foreign_key "known_mini_feeds", "known_feeds"
  add_foreign_key "mini_feeds", "main_feeds"
end
